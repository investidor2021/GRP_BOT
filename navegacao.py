...
def ir_para_anulacao_empenhos(page):
    page.goto(
        "https://sistemas.vgsul.sp.gov.br/GRP/home/ctp/despesa/anulacaodocumentodespesa",
        wait_until="domcontentloaded",
        timeout=60000
    )
    ...
    try:
        ...
        page.screenshot(path="erro_tela_oracle.png", full_page=True)
        raise Exception(f"Robô travou na URL de Anulação: {page.url}\nTirou um 'print' da tela invisível e salvou como 'erro_tela_oracle.png' na pasta do servidor. Erro original: {e}")
